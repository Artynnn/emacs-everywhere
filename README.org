...
/This is fork of Tecosaur's Emacs every package. I added things to support easier archiving of my comments. Though the setup is complicated and not recommended for general use./
